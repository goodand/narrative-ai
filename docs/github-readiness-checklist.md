...
- [ ] README wording이 현재 private GitHub CI 목표와 맞는다.
- [ ] `.maestro/` flow와 `docs/testing/maestro.md`가 필요하다면 tracked 상태로 포함한다.
...
- [ ] `.env.example`와 `.github/workflows/ci.yml`가 tracked 상태다.
- [ ] 첫 GitHub Actions run 결과가 green이다.
