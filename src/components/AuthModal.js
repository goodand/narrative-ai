...
export class AuthModal extends Modal {
    ...
    render() {
        ...
        const html = this._getUnifiedAuthHTML();
        ...
        return `
            <div class="flex flex-col h-full px-8 py-12 text-center bg-dark-bg">
                ...
                <footer class="w-full flex flex-col items-center pb-8">
                    <button id="google-auth-btn" class="w-full bg-white text-black py-4 px-6 rounded-[24px] flex items-center justify-center gap-3 active:scale-[0.98] transition-all mb-3 shadow-lg shadow-white/5">
