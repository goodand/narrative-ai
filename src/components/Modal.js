    ...
    renderSuggestions(wordData, onSelect) {
        ...
        if (suggestions.length === 0) {
            ...
            suggestions.forEach(suggestion => {
                ...
                button.className = "w-full text-left p-4 hover:bg-primary hover:text-dark-bg rounded-3xl font-bold border border-white/10 bg-field-bg text-white mb-2 transition-colors";
        ...
        if (container) {
            container.innerHTML = `
                ...
                <div class="flex gap-3">
                    <button id="dyn-modal-cancel" class="flex-1 h-14 rounded-3xl font-bold bg-transparent border border-white/10 text-[#B2B0B5] hover:bg-white/5 transition-colors">${cancelText}</button>
                    <button id="dyn-modal-confirm" class="flex-1 h-14 rounded-3xl font-bold bg-primary text-dark-bg hover:bg-primary/90 transition-colors">${confirmText}</button>
                </div>
            `;
            this.setup({
